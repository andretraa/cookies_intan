...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            <div class="logo-wrap">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Cookies Intan" class="logo-img">
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" id="email" name="email" class="form-input" 
                               value="<?php echo e(old('email', 'admin@cookiesintan.com')); ?>" 
...
<?php /**PATH C:\Users\LENOVO\.gemini\antigravity-ide\scratch\barbershop\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>