    ...
    <div class="hero-inner">
        ...
        <div class="hero-image">
            <div class="hero-image-main">
                <img src="<?php echo e(asset('images/hero_cookies.jpg')); ?>" alt="Cookies dan Brownies Homemade Cookies Intan" loading="eager">
            </div>
...
<section class="about-section" id="about">
    <div class="about-inner">
        ...
        <div class="about-images reveal-left">
            <img class="about-img-main" src="<?php echo e(asset('images/hero_cookies.jpg')); ?>" alt="Tentang Cookies Intan" loading="lazy">
            <img class="about-img-secondary" src="<?php echo e(asset('images/cookies.jpg')); ?>" alt="Proses pembuatan cookies" loading="lazy">
