<?php $__env->startSection('title', 'Tambah Menu & Foto Baru'); ?>
        ...
        <div class="form-layout">
            ...
            <div class="form-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Contoh: Double Choco Brownies" required>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catKey => $catLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($catKey); ?>" <?php echo e(old('category') === $catKey ? 'selected' : ''); ?>>
                                    <?php echo e($catLabel); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="badge" name="badge" class="form-control" value="<?php echo e(old('badge')); ?>" placeholder="Contoh: Best Seller, Favorit, Baru">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" class="form-control" value="<?php echo e(old('price')); ?>" placeholder="Contoh: 45000" min="0" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="price_unit">Satuan Harga <span class="req">*</span></label>
                        <input type="text" id="price_unit" name="price_unit" class="form-control" value="<?php echo e(old('price_unit', '/box')); ?>" placeholder="Contoh: /box, /pcs, /set, /cup" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" placeholder="Tuliskan rasa, tekstur, atau keistimewaan menu ini..."><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div class="form-row" style="align-items: center;">
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <input type="number" id="sort_order" name="sort_order" class="form-control" value="<?php echo e(old('sort_order', 0)); ?>" placeholder="0">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\.gemini\antigravity-ide\scratch\barbershop\resources\views/admin/catalog/create.blade.php ENDPATH**/ ?>