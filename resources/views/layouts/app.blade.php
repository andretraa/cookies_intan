...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="navbar-inner">
            <a href="{{ route('home') }}" class="navbar-brand">
                <img src="{{ asset('images/logo.png') }}" alt="Cookies Intan Logo" style="height: 50px; width: 50px; border-radius: 50%; object-fit: cover; box-shadow: 0 2px 8px rgba(140, 94, 60, 0.18);">
            ...
            <ul class="nav-links" id="navLinks">
                <li><a href="{{ route('home') }}#menu">Katalog</a></li>

                <li><a href="{{ route('home') }}#about">Tentang Kami</a></li>
                <li><a href="{{ route('home') }}#cara-pesan">Cara Pesan</a></li>
            ...
            <div class="nav-actions">
                @auth
                    @if(Auth::user()->isAdmin())
                        <a href="{{ route('admin.catalog.index') }}" class="btn-nav-admin">
    ...
    <footer class="footer">
        <div class="footer-inner">
            ...
            <div class="footer-brand">
                <div class="navbar-brand" style="margin-bottom:14px;">
                    <img src="{{ asset('images/logo.png') }}" alt="Cookies Intan Logo" style="height: 56px; width: 56px; border-radius: 50%; object-fit: cover; box-shadow: 0 2px 8px rgba(0,0,0,0.2);">
                    <div class="brand-text">
        ...
        <div class="footer-bottom">
            <p class="footer-copy">© {{ date('Y') }} <span>Cookies Intan</span>. All Rights Reserved. Freshly made with <span>♥</span> love.</p>
            <div style="display: flex; align-items: center; gap: 16px;">
                @auth
                    @if(Auth::user()->isAdmin())
                        <a href="{{ route('admin.catalog.index') }}" style="color: var(--gold-light); font-size: 0.82rem; display: inline-flex; align-items: center; gap: 6px; font-weight: 600;">
                            <i class="fa-solid fa-gauge"></i> Panel Admin
                        </a>
                    @endif
                @else
                    <a href="{{ route('admin.login') }}" style="color: rgba(255,255,255,0.4); font-size: 0.82rem; display: inline-flex; align-items: center; gap: 6px; transition: color 0.2s;" onmouseover="this.style.color='#F0C96B'" onmouseout="this.style.color='rgba(255,255,255,0.4)'">
