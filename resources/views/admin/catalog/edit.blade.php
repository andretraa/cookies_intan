...
@section('title', 'Ubah Menu & Foto Katalog')
...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Ubah Menu: {{ $product->name }}</h1>
    ...
    <form action="{{ route('admin.catalog.update', $product) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-layout">
            ...
            <div class="form-card">
                ...
                <div class="current-image-wrap">
                    <img src="{{ $product->image_url }}" alt="{{ $product->name }}" id="currentImg">
            ...
            <div class="form-card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-control" required>
                            @foreach($categories as $catKey => $catLabel)
                                <option value="{{ $catKey }}" {{ old('category', $product->category) === $catKey ? 'selected' : '' }}>
                                    {{ $catLabel }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="badge" name="badge" class="form-control" value="{{ old('badge', $product->badge) }}" placeholder="Contoh: Best Seller, Favorit, Baru">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" class="form-control" value="{{ old('price', (int)$product->price) }}" min="0" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="price_unit">Satuan Harga <span class="req">*</span></label>
                        <input type="text" id="price_unit" name="price_unit" class="form-control" value="{{ old('price_unit', $product->price_unit) }}" placeholder="Contoh: /box, /pcs, /set, /cup" required>
                    </div>
                </div>
                ...
                <div class="form-row" style="align-items: center;">
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <input type="number" id="sort_order" name="sort_order" class="form-control" value="{{ old('sort_order', $product->sort_order) }}">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <label class="checkbox-wrap">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $product->is_active ? '1' : '0') == '1' ? 'checked' : '' }}>
